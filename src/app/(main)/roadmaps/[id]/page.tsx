    ...
    <div className="container mx-auto px-4 py-8">
      <div className="w-full flex flex-col lg:grid grid-cols-12 lg:space-x-5">
        <section className="col-span-9 relative z-20">
          <div className="w-full py-12 px-6 bg-gray-300 dark:bg-black dark:bg-gradient-to-tr from-muted via-muted to-red-800 dark:from-black dark:via-black/50 dark:to-red-800">
